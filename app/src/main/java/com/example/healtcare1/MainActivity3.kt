...
class MainActivity3 : AppCompatActivity() {
    ...
    private lateinit var dataList: ArrayList<DtaClass>
    ...
    private lateinit var searchList: ArrayList<DtaClass>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList = arrayListOf<DtaClass>()
        searchList = arrayListOf<DtaClass>()
        getData()
    ...
    private fun getData(){
        for (i in imageList.indices){
            val dataClass = DtaClass(imageList[i], titleList[i], descList[i], detailImageList[i])
