...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageList = arrayOf(
            R.drawable.beslenme,
            R.drawable.egzersiz,
            R.drawable.stresyonetimi,
            R.drawable.kisiselgelisim,
            R.drawable.uyku)
        ...
        descList = arrayOf(
            getString(R.string.Beslenme),
            getString(R.string.Egzersiz),
            getString(R.string.Stres_Yönetimi),
            getString(R.string.Kişisel_Gelişim),
            getString(R.string.Uyku))
